...
public class EntitiesParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected org.examples.entities.parser.antlr.internal.InternalEntitiesParser createParser(XtextTokenStream stream) {
		return new org.examples.entities.parser.antlr.internal.InternalEntitiesParser(stream, getGrammarAccess());
	}
