...
* generated by Xtext
*/
package org.examples.entities.services;
...
public class EntitiesGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class EntityElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cAttibutesAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cAttibutesAttributeParserRuleCall_4_0 = (RuleCall)cAttibutesAssignment_4.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_5 = (Keyword)cGroup.eContents().get(5);
		
		//Entity:
		//	"entity" name=ID ("extends" superType=[Entity])? "{" attibutes+=Attribute* "}";
		public ParserRule getRule() { return rule; }
		...
		//attibutes+=Attribute*
		public Assignment getAttibutesAssignment_4() { return cAttibutesAssignment_4; }

		//Attribute
		public RuleCall getAttibutesAttributeParserRuleCall_4_0() { return cAttibutesAttributeParserRuleCall_4_0; }
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.examples.entities.Entities".equals(grammar.getName())) {
				return grammar;
			}
