 ...
 * <ul>
 *   <li>{@link org.example.expressions.expressions.impl.ExpressionModelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExpressionModelImpl extends MinimalEObjectImpl.Container implements ExpressionModel
{
  ...
  {
    return ExpressionsPackage.Literals.EXPRESSION_MODEL;
  }
  ...
  public EList<AbstractElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<AbstractElement>(AbstractElement.class, this, ExpressionsPackage.EXPRESSION_MODEL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ExpressionsPackage.EXPRESSION_MODEL__ELEMENTS:
